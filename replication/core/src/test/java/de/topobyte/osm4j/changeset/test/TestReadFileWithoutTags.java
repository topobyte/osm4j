...
public class TestReadFileWithoutTags implements OsmChangesetsHandler
{

	@Test
	public void test() throws IOException, OsmInputException
	{
		// This file has a changeset that doesn't have any tags (id 104943084)
		String filename = "004-458-534.osm.gz";
