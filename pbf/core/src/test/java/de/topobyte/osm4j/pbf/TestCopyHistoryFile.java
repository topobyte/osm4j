...
public class TestCopyHistoryFile
{
	...
	public void test() throws IOException
	{
		...
		Path filenameOutput = SystemPaths.HOME
				.resolve("Downloads/berlin-internal.osh.copy.pbf");

		InputStream input = Files.newInputStream(fileInput);
		OutputStream output = Files.newOutputStream(filenameOutput);

		PbfWriter writer = new PbfWriter(output, true);
