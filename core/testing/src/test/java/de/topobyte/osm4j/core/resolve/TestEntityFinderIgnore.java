...
public class TestEntityFinderIgnore extends BaseTestDataSets
{

	private EntityFinder finder;

	public TestEntityFinderIgnore(Loader loader)
	{
		super(loader);
	}
	...
	{
		super.prepare();
		finder = EntityFinders.create(data, EntityNotFoundStrategy.IGNORE);
	}
	...
	{
		List<OsmNode> nodes = finder.findNodes(TroveUtil.collection(4));
	...
	{
		List<OsmWay> ways = finder.findWays(TroveUtil.collection(5));
		assertEquals(0, ways.size());
	}
