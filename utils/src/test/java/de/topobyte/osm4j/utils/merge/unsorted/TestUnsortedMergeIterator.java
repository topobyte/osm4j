...
public class TestUnsortedMergeIterator extends BaseTest
{
	...
	public void test(int numNodes, int numWays, int numRelations, int numFiles)
			throws IOException
	{
		setup(numNodes, numWays, numRelations, numFiles);
		...
		UnsortedMergeIterator merger = new UnsortedMergeIterator(inputs);
