...
public class OsmCollectRelations extends AbstractEntityCollector
{

	@Override
	protected String getHelpMessage()
	{
		return OsmCollectRelations.class.getSimpleName() + " [options]";
	}

	public static void main(String[] args) throws IOException
	{
		OsmCollectRelations task = new OsmCollectRelations();
	...
	{
		return ids.contains(relation.getId());
	}
